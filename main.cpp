...
void graphicsCallback() {
    ...
    Eigen::Vector3f p = (opti->rigidObjects)[3]->position;
...
#pragma opm parallel
    ...
    HDdouble cam_x = (HDdouble)(opti_to_hapt[0]);
    HDdouble cam_y = (HDdouble)(opti_to_hapt[1]);
    HDdouble cam_z = (HDdouble)(opti_to_hapt[2]);
